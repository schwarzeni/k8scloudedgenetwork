...
var (
	addr            = flag.String("addr", ":8889", "cloud server addr")
	serviceDBAddr   = flag.String("svcdbaddr", "http://10.211.55.2:8881", "service db addr")
	proxyServerAddr = flag.String("proxyaddr", ":8080", "proxy server addr")
)
...
func main() {
	...
	go RunHTTPProxyServer(*proxyServerAddr, proxyChannelManager)
